...
const Main_dash = () => {
 ...
 <div className="bg-white shadow-2xl max-w-[500px] rounded-2xl p-6 mx-3 border border-gray-200   transition-all hover:shadow-3xl">
    ...
    <div className="bg-white shadow-lg max-w-[500px] rounded-xl p-4 sm:p-6 mx-3 border border-gray-200 w-full">
      <h2 className="text-lg font-semibold mb-4 text-gray-700 text-center">Appointment Request</h2>
      <div className="space-y-4">
        {requests.map((req, index) => (
          <div key={index} className="flex flex-col sm:flex-row items-center bg-gray-50 p-4 rounded-lg shadow-sm border border-gray-200 space-y-4 sm:space-y-0 sm:space-x-4">
            <img
              src={req.avatar}
              alt={req.name}
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <p className="text-gray-500">{req.issue}</p>
            </div>
            <div className="flex sm:flex-col sm:space-y-2 space-x-2 sm:space-x-0 w-full sm:w-auto justify-center">
              <button className="bg-green-500 text-white py-1 px-3 rounded-md font-medium hover:bg-green-600 transition w-full sm:w-auto">Confirm</button>
