...
const About = () => {
  return (
    <>
      <div className='about_container  md:mt-10 flex flex-col md:flex-row   mx-1 md:justify-center gap-4 lg:gap-20   '>
...
<div className='lg:max-w-[900px] mx-1 lg:pt-[50px] md:pt-[5px] md:mt-0 mt-2'>
  <div className='relative  hidden z-10 sm:block   justify-center '>
    <img src={doctor} alt="" className='max-h-[500px] min-w-[300px]' />
...
<div className='lg:max-w-[500px]  mx-1 lg:pt-[50px] md:pt-[5px] md:mt-0 mt-2'>
  ...
  <div className='relative sm:hidden mt-3 z-10 flex justify-center max-h-[370px] max-w-[500px] '>
  ...
  <div><p className='mt-4 md:text-[15px]'>For 30 years in a row , Us News & World Report has recognized as one of 
    ...
    <p className='md:mt-4 md:text-[15px] md:leading-7'>Our best is something we strive for each day caring for our pationts 
