...
const About = () => {
  return (
    <>
      <div className='about_container  mt-10 flex flex-col lg:flex-row  mx-3 lg:justify-center gap-4 lg:gap-20   '>


<div className='lg:max-w-[900px] mx-1 lg:pt-[50px] md:pt-[5px] md:mt-0 mt-2'>
  <div className='relative z-10 flex justify-center '>
    <img src={doctor} alt="" className='max-h-[500px]' />
...
<div className='lg:max-w-[500px] mx-1 lg:pt-[50px] md:pt-[5px] md:mt-0 mt-2'>
  ...
  <div><p className='mt-4 md:text-[15px]'>For 30 years in a row , Us News & World Report has recognized as one of 
    ...
    <p className='mt-4 md:text-[15px] leading-7'>Our best is something we strive for each day caring for our pationts 
      ...
      asperiores possimus est veniam minus optio ipsum perspiciatis ullam nam alias.
    </p>
    </div>
